...
class ValueAssertion extends VariableSetAssertion
{
	 ...
	 * @param \XBRL_Log $log
	 */
	public function ProcessEvaluationResultInArray(array &$result )
	{
		...
		// \XBRL_Log::getInstance()->info("Value assertion result for '{$this->label}': There are $satisfied satisfied and $unsatisfied not satisfied evaluations.");
		$msg = "Value assertion Result for '{$this->id} ($this->linkbase)': There are $satisfied satisfied and $unsatisfied not satisfied evaluations.";
		$result[] = $msg;
	}
	/**
